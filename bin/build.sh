...
# Connect into aws
$(aws ecr get-login-password --region ap-southeast-1 | docker login --username AWS --password-stdin $aws_ecr_repository_url_with_tag) || { echo 'ERROR: aws ecr login failed' ; exit 1; }
